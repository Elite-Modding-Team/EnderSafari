...
public class EntityEnderminy extends EntityMob {
    ...
    protected void initEntityAI() {
        ...
        if (ESConfig.ENTITIES.ENDERMINY.enablePlayerHostility) {
            this.targetTasks.addTask(2, new EntityEnderminy.AIFindPlayer(this));
        }
        if (ESConfig.ENTITIES.ENDERMINY.enableCreeperHostility) {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(ESConfig.ENTITIES.ENDERMINY.armor);
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(ESConfig.ENTITIES.ENDERMINY.attackDamage);
        this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(32.0D);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.ENDERMINY.maxHealth);
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(ESConfig.ENTITIES.ENDERMINY.movementSpeed);
    }
    ...
    protected ResourceLocation getLootTable() {
        return ModLootTablesES.ENDERMINY;
    }
    ...
    private void doGroupAggro(EntityLivingBase target) {
        if (!ESConfig.ENTITIES.ENDERMINY.enableGroupAggro || target == null) return;
