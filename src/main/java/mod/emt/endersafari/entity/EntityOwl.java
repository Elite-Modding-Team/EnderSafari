...
import mod.emt.endersafari.entity.navigator.FlyingMoveHelper;
...
public class EntityOwl extends EntityAnimal implements IESFlyingMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(ESConfig.ENTITIES.OWL.armor);
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(ESConfig.ENTITIES.OWL.attackDamage);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.OWL.maxHealth);
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(ESConfig.ENTITIES.OWL.movementSpeed);
    }
    ...
    public int getTalkInterval() {
        return ESConfig.ENTITIES.OWL.hootInterval;
    }
    ...
    public void playLivingSound() {
        ...
        playSound(getAmbientSound(), getSoundVolume() * (float) ESConfig.ENTITIES.OWL.hootVolume, 0.8f * getSoundPitch());
    }

    @Override
    protected SoundEvent getAmbientSound() {
        return ModSoundEventsES.ENTITY_OWL_HOOT.getSoundEvent();
    }

    @Override
    protected SoundEvent getHurtSound(@NotNull DamageSource source) {
        return ModSoundEventsES.ENTITY_OWL_HURT.getSoundEvent();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSoundEventsES.ENTITY_OWL_DEATH.getSoundEvent();
    }
