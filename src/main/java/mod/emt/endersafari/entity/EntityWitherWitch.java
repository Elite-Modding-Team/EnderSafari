...
public class EntityWitherWitch extends EntityMob implements IRangedAttackMob {
    ...
    private boolean initialCatsSpawn = ESConfig.ENTITIES.WITHER_WITCH.enableCatSpawning;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(ESConfig.ENTITIES.WITHER_WITCH.armor);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.WITHER_WITCH.maxHealth);
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(ESConfig.ENTITIES.WITHER_WITCH.movementSpeed);
    }
    ...
    private void spawnCats() {
        ...
        int count = ESConfig.ENTITIES.WITHER_WITCH.catSpawnMin + this.rand.nextInt(ESConfig.ENTITIES.WITHER_WITCH.catSpawnMax);
    ...
    protected ResourceLocation getLootTable() {
        return ModLootTablesES.WITHER_WITCH;
    }
