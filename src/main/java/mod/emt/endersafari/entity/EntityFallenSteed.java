...
public class EntityFallenSteed extends EntityHorse implements IMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(ESConfig.ENTITIES.FALLEN_STEED.armor);
        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.ATTACK_DAMAGE);
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(ESConfig.ENTITIES.FALLEN_STEED.attackDamage);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.FALLEN_STEED.maxHealth);
    }
    ...
    public IEntityLivingData onInitialSpawn(@NotNull DifficultyInstance diff, @Nullable IEntityLivingData data) {
        ...
        double chanceOfArmor = (world.getDifficulty() == EnumDifficulty.HARD ? ESConfig.ENTITIES.FALLEN_STEED.horseArmorChanceHard : ESConfig.ENTITIES.FALLEN_STEED.horseArmorChance);
    ...
    protected @NotNull ResourceLocation getLootTable() {
        return ModLootTablesES.FALLEN_STEED;
    }
}