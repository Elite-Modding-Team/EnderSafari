...
public class EntityAIFollowOwnerES extends EntityAIBase {
    @Nonnull
    IESOwnable<? extends EntityCreature, ? extends EntityLivingBase> owned;
    double followSpeed;
    private int pathingTimer;
    private final double minDistanceSq;
    private final double maxDistanceSq;

    public EntityAIFollowOwnerES(@Nonnull IESOwnable<? extends EntityCreature, ? extends EntityLivingBase> owned, double minDist, double maxDist, double followSpeed) {
        this.owned = owned;
