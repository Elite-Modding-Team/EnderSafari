...
public class EntityVoidCube extends EntityMagmaCube {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.VOID_CUBE.maxHealth);
    }
    ...
    public void setSlimeSize(int size, boolean resetHealth) {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(ESConfig.ENTITIES.VOID_CUBE.attackDamage);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.VOID_CUBE.maxHealth);
        if (resetHealth) {
    ...
    private void onLivingUpdateServer() {
        if (actionDelay-- <= 0) {
            for (EntityPlayer player : getClosestPlayers(ESConfig.ENTITIES.VOID_CUBE.blindnessRange)) {
    ...
    protected ResourceLocation getLootTable() {
        return ModLootTablesES.VOID_CUBE;
    }
}
