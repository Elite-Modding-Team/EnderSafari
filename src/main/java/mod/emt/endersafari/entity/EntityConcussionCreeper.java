...
public class EntityConcussionCreeper extends EntityCreeper {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(ESConfig.ENTITIES.CONCUSSION_CREEPER.armor);
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ESConfig.ENTITIES.CONCUSSION_CREEPER.maxHealth);
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(ESConfig.ENTITIES.CONCUSSION_CREEPER.movementSpeed);
    }
        ...
        if (this.isEntityAlive()) {
            ...
            if (this.timeSinceIgnitedCustom >= this.fuseTime) {
                ...
                if (!this.world.isRemote) {
                    ConcussionExplosion.create(this.world, this, this.posX, this.posY, this.posZ, (float) ESConfig.ENTITIES.CONCUSSION_CREEPER.explosionRange, false, false);
                    this.setDead();
                }
            }
        }
    ...
    protected ResourceLocation getLootTable() {
        return ModLootTablesES.CONCUSSION_CREEPER;
    }
}
