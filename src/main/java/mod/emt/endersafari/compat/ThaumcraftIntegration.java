...
public class ThaumcraftIntegration {
    ...
    public void registerAspects(AspectRegistryEvent event) {
        ...
        // Items
        proxy.registerObjectTag(new ItemStack(ModItemsES.CONFUSING_DUST), new AspectList().add(Aspect.ALCHEMY, 5).add(Aspect.MIND, 10).add(Aspect.MOTION, 10));
        proxy.registerObjectTag(new ItemStack(ModItemsES.ENDER_FRAGMENT), new AspectList().add(Aspect.ELDRITCH, 2).add(Aspect.MOTION, 3));
        proxy.registerObjectTag(new ItemStack(ModItemsES.EPIC_INK_SAC), new AspectList().add(Aspect.AURA, 2).add(Aspect.FIRE, 2).add(Aspect.SENSES, 5));
        proxy.registerObjectTag(new ItemStack(ModItemsES.GUARDIAN_BOW), new AspectList().add(Aspect.AVERSION, 20).add(Aspect.FLIGHT, 10).add(Aspect.PROTECT, 10));
        proxy.registerObjectTag(new ItemStack(ModItemsES.OWL_EGG), new AspectList().add(Aspect.FLIGHT, 5).add(Aspect.LIFE, 5));
        proxy.registerObjectTag(new ItemStack(ModItemsES.WITHERING_DUST), new AspectList().add(Aspect.ALCHEMY, 5).add(Aspect.DEATH, 10).add(Aspect.ENTROPY, 10));
    }
}
