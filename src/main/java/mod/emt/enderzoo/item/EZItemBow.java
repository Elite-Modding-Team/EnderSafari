...
public class EZItemBow extends ItemBow {
    ...
    public EZItemBow(String unlocName, int durability, float damageMult, float velocityMult, float drawTimeMult, float inaccuracy, Ingredient repairMaterial, EnumRarity rarity) {
