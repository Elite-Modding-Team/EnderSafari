...
public class EntityDireWolf extends EntityMob {
    ...
    protected SoundEvent getAmbientSound() {
        ...
        if (howl) {
            ...
            return ModSoundEventsEZ.ENTITY_DIRE_WOLF_HOWL.getSoundEvent();
        } else {
            return ModSoundEventsEZ.ENTITY_DIRE_WOLF_GROWL.getSoundEvent();
        }
    }
    ...
    protected @NotNull SoundEvent getHurtSound(@NotNull DamageSource source) {
        return ModSoundEventsEZ.ENTITY_DIRE_WOLF_HURT.getSoundEvent();
    }

    @Override
    protected @NotNull SoundEvent getDeathSound() {
        return ModSoundEventsEZ.ENTITY_DIRE_WOLF_DEATH.getSoundEvent();
    }
    ...
    protected ResourceLocation getLootTable() {
        return ModLootTablesEZ.DIRE_WOLF;
    }
}