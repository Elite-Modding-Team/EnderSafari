...
import mod.emt.enderzoo.entity.EntityUtil;
...
public class EntityAIFlyingLand extends EntityAIBase {
    ...
    private final int defSearchRange = 3;
    private final int maxSearchRange = 16;
    private int searchRange = 4;
    private final int searchAttempts = 10;
    ...
    public boolean shouldExecute() {
        ...
        if (target == null) {
            // Failed so increase the search range for next time
