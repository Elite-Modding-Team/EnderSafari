...
public class EntityAIAttackOnCollideOwned extends EntityAIAttackMelee {
    private final IEZOwnable<? extends EntityCreature, ? extends EntityLivingBase> ownable;
    private boolean retreating;
    private final EntityAIFollowOwnerEZ followTask;

    public EntityAIAttackOnCollideOwned(IEZOwnable<? extends EntityCreature, ? extends EntityLivingBase> ownable, double speed, boolean useLongMemory, EntityAIFollowOwnerEZ followTask) {
