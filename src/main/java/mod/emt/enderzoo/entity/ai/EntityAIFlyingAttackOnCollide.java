...
public class EntityAIFlyingAttackOnCollide extends EntityAIBase {
    ...
    private final IEZFlyingMob flyingMob;

    public EntityAIFlyingAttackOnCollide(IEZFlyingMob mob, Class<? extends Entity> targetClass, double speed, boolean useLongMemory) {
        this(mob, speed, useLongMemory);
        this.classTarget = targetClass;
    }

    public EntityAIFlyingAttackOnCollide(IEZFlyingMob mob, double speed, boolean useLongMemory) {
        this.flyingMob = mob;
